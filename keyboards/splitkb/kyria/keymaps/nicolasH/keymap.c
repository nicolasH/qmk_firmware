...
#define LT_N_S_SPC LT(_NUM_SYM,KC_SPC)
#define LT_F_N_TAB LT(_FUN_NAV,KC_TAB)

#define LT_N_S_ENT LT(_NUM_SYM,KC_ENT)
#define LT_F_N_BSP LT(_FUN_NAV,KC_BSPC)


#define LT_RGB_ESC LT(_RGB,KC_BSPC)
#define LT_RGB_DEL LT(_RGB,KC_DEL)
 ...
 * |    `   |   Z  |   X  |   C  |   D  |   V  | ---- | ---- |  | ---- | ---- |   K  |   H  | ,  < | . >  | /  ? |  - _   |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        |  "   |   '  | Space| Tab  | Esc  |  | Del  | Ent  | Bksp |      |      |
 *                        |      |      |Num Sy| F Nav| RGB  |  |      |Num Sy| F Nav|      |      |
 *                        `----------------------------------'  `----------------------------------'
 */
  ...
  [_CMK] = LAYOUT(
      ...
      KC_GRV,         KC_Z,   KC_X,   KC_C,   KC_D,   KC_V, _______, _______,                      _______, _______, KC_K,     KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  KC_EQUAL,
                                KC_DQT, KC_QUOT, LT_N_S_SPC, LT_F_N_TAB, KC_ESC,                  KC_DEL , LT_N_S_ENT, LT_F_N_BSP,    KC_MINS, KC_UNDS
						       ),
  ...
  [_NUM_SYM] = LAYOUT(
		  _______,KC_PLUS , KC_7,    KC_8,    KC_9,  KC_ASTR,                                   KC_EXLM, KC_AT ,  KC_LCBR, KC_RCBR, KC_AMPR,_______,
		  _______,KC_MINS , KC_4,    KC_5,    KC_6,  KC_SLASH,                                  KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_ASTR,_______,
		  _______,KC_EQUAL, KC_1,    KC_2,    KC_3,  KC_ENTER,_______,_______,  _______,_______,KC_PERC, KC_CIRC, KC_LT,   KC_GT,   KC_DQUO,_______,
                                     KC_0,   KC_DOT,  _______,        _______,_______,  _______,_______,         _______, KC_LBRC, KC_RBRC
		  ),
  [_FUN_NAV] = LAYOUT(
		  _______,_______, KC_F7,    KC_F8,   KC_F9, KC_F10,                                    _______,_______,KC_PGUP,_______,_______, KC_INSERT,
		  _______,_______, KC_F4,    KC_F5,   KC_F6, KC_F11,                                    KC_HOME,KC_LEFT,KC_UP  ,KC_DOWN,KC_RIGHT,KC_END ,
		  _______,KC_EJCT, KC_F1,    KC_F2,   KC_F3, KC_F12,_______,_______,    _______,_______,_______,_______,_______,KC_PGDN,_______,_______,
	                                    _______,_______,_______,_______,_______,    _______,_______,_______,_______,_______
		      ),
